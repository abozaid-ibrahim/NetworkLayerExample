...
enum APIError: Int, LocalizedError, Codable {
    case serviceProblem, success, userInfoNotMatching, userBlocked, userNotActivated, userNotAuth, missingParams, emailDublicated, passwordMissing, languageNotSupported, timezoneRequired, usernameDublicated, projectNameReuqired,dataIsNil,jsonParsingFail
}
